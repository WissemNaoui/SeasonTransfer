...
class Generator(nn.Module):
    def __init__(self, img_channels=3, num_residuals=9):
        super().__init__()
        # MATCHING SAVED WEIGHTS: Direct Conv2d (not a block)
        self.initial = nn.Conv2d(img_channels, 64, kernel_size=7, stride=1, padding=3, padding_mode="reflect")
        ...
        # MATCHING SAVED WEIGHTS: Named 'res_blocks' (not 'residual_blocks')
        ...
        # MATCHING SAVED WEIGHTS: Direct Conv2d
